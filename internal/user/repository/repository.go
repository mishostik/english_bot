...
func (ur *UserRepository) UserByID(ctx context.Context, userID int) (*user.User, error) {
...
func (ur *UserRepository) RegisterUser(ctx context.Context, user *user.User) error {
